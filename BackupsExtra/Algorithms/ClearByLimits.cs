    ...
    public class ClearByLimits : IExtraAlgorithm
    {
        ...
        public ClearByLimits(List<IExtraAlgorithm> extraAlgorithms)
        {
            _extraAlgorithms = extraAlgorithms ??
                               throw new BackupsException("Invalid extraAlgorithms in ClearByLimits algorithm");
        }
        ...
        public IReadOnlyList<RestorePoint> FindPointsToClear(ExtraBackupJob extraBackupJob)
        {
            ...
            return _extraAlgorithms.SelectMany(algorithm => algorithm.FindPointsToClear(extraBackupJob))
                .ToImmutableList();
        }
        ...
        {
            if (extraBackupJob is null)
                throw new BackupsException("Invalid ExtraBackupjob in ClearByDate algorithm (ClearPoints)");
        ...
        public IClearLimitSnapShot ToSnapshot() => new ClearByLimitsSnapShot()
